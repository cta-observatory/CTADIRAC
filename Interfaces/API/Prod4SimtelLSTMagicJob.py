"""
  Wrapper on the Job class to handle Simtel Analysis of the PROD4 LST+Magic Corsika
  showers

  https://forge.in2p3.fr/issues/35807
                        April 11th 2019 - J. Bregeon
"""
...
class Prod4SimtelLSTMagicJob(Job):
    ...
    def __init__(self, cpuTime=432000):
        ...
        self.version = '2018-11-07-lstmagic'
        self.configuration_id = 5
        self.output_data_level = DATA_LEVEL_METADATA_ID['DL0']
        self.N_output_files = 2 # 1 data and 1 log tar file
    ...
    def setupWorkflow(self, debug=False):
        ...
        if self.metadata['particle'] == 'gamma-diffuse':
            cone10_tag='_cone10'
        output_pattern = './*lst-magic%s_data.tar' % cone10_tag
