...
class Prod3MCPipeBaselineTS2Job( Job ) :
  ...
  def __init__( self, cpuTime = 259200 ):
    ...
    self.outputquery = {'MCCampaign':'PROD3','outputType':{'in': ['Data', 'Log']}}
  ...
  def setPackage(self, package):
    ...
    self.outputquery['tel_sim_prog'] = 'simtel'
  ...
  def setVersion(self, version):
    ...
    self.outputquery['tel_sim_prog_version'] = version
  ...
  def setArrayLayout(self, layout):
    ...
    if layout in ['Baseline']:
        ...
        self.outputquery['array_layout'] = layout
    else:
  ...
  def setSite(self, site):
    ...
    """
    self.cta_site=site
    self.outputquery.update({'site':site})
  ...
  def setParticle(self, particle):
    ...
    if particle in ['gamma','gamma-diffuse','electron','proton','helium']:
        ...
        self.outputquery['particle'] = particle
    else:
  ...
  def setPointingDir(self, pointing):
    ...
    if pointing in ['North', 'South', 'East', 'West']:
        ...
        if self.pointing_dir == 'North':
          self.outputquery['phiP'] = 180
        if self.pointing_dir == 'South':
          self.outputquery['phiP'] = 0
    else:
  ...
  def setZenithAngle( self, zenith ):
    ...
    self.outputquery['thetaP'] = zenith

  def setOutputDataLevel( self, output_data_level ):    
    self.output_data_level = output_data_level
    self.outputquery['data_level'] = output_data_level

  def setConfigurationId( self, configuration_id ):
    self.configuration_id = configuration_id
    self.outputquery['configuration_id'] = configuration_id
