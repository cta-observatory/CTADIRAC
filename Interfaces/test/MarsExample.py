""" Script to create a Mars Transformation
"""
...
from CTADIRAC.Interfaces.API.MarsJob import MarsJob
...
def runMars( args = None ):
  """ Simple wrapper to create MarsJob and setup parameters
...
##################################
  job = MarsJob( cpuTime = 432000 )  # to be adjusted!!

  ### Main Script ###
  job.setName( 'MarsTest' )
