...
def installProd3sw( args = None ):
  """ Simple wrapper to install Prod3 sw package
  """
...
# ##
  ...
  Step = job.setExecutable( './cta-installprod3sw.py',
                            arguments = '%s %s' % ( package, version ), \
                            logFile = 'installSoftware_Log.txt' )
  Step['Value']['name'] = 'Step_installSoftware'
  Step['Value']['descr_short'] = 'install Software'

  # override for testing
  job.setName('InstallProd3Sw')
