...
__RCSID__ = "36b3a10 (2016-11-28 17:43:10 +0100) arrabito <arrabito@in2p3.fr>"
...
class TSCatalog2Client( FileCatalogClientBase ):
  ...
  def __init__( self, url = None, **kwargs ):
    ...
    self.serverURL = 'Transformation2/TransformationManager' if not url else url
    super( TSCatalog2Client, self ).__init__( self.serverURL, **kwargs )
