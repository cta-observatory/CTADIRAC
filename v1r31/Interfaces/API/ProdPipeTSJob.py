"""
  Simple Wrapper on the Job class to handle Production Jobs with TS
"""
...
class ProdPipeTSJob( Job ) :
  ...
  def setParameters(self, parameters = None):
    ...
    self.setExecutable('$DIRACROOT/scripts/cta-prodpipets',argumentStr)
